...
func New(ctx context.Context) (*App, error) {
	...
	route.RegisterRoutes(mux, route.Handlers{
		...
		StoreLoteoArchivo: container.StoreLoteoArchivoHandler,
		StoreLoteArchivo:  container.StoreLoteArchivoHandler,
		ListLoteoArchivos: container.ListLoteoArchivosHandler,
		ListLoteArchivos:  container.ListLoteArchivosHandler,
		GetArchivoContent: container.GetArchivoContentHandler,
		DeleteArchivo:     container.DeleteArchivoHandler,
